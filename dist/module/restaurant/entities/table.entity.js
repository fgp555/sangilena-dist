...
], TableEntity.prototype, "available", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => restaurant_entity_1.RestaurantEntity, (restaurant) => restaurant.tables, {
        onDelete: "CASCADE",
    }),
    __metadata("design:type", restaurant_entity_1.RestaurantEntity)
], TableEntity.prototype, "restaurant", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => user_entity_1.UserEntity, (user) => user.tables, {
        // cascade: true,
        eager: true,
    }),
    (0, typeorm_1.JoinTable)(),
    __metadata("design:type", Array)
], TableEntity.prototype, "users", void 0);
